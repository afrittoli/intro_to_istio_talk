...
\author[Michele,Andrea]{%
  \texorpdfstring{
      \begin{columns}
          ...
          \centering
          Michele Buccarello\\
          Job Title to be entered here
          \href{mailto:tbd@foo.bar}{some email to be entered here}\\
          @TBD\\
      \end{columns}
  }
  {Michele Buccarello}
...
\title[Introduzione a Istio
\hspace{2em}\insertframenumber/\inserttotalframenumber]{Introduzione a Istio}
...
\begin{frame}[noframenumbering]
    ...
    \titlepage{}
    \centering
    \href{https://github.com/afrittoli/intro\_to\_istio\_talk}{https://github.com/afrittoli/intro\_to\_istio\_talk}
\end{frame}
}
